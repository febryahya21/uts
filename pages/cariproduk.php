...
<!-- banner -->
	<div class="banner3" id="home1">
		<div class="container">
			<h2>Busana Wanita<span>up to</span> Flat 30% <i>Discount</i></h2>
		</div>
	</div>
<!-- //banner -->
  ...
  $halaman=1; }
    ...
    $posisi=($halaman-1)*$batas; 
				...
				<div class="col-md-8 w3ls_dresses_grid_right">
					...
					<?php
						$kata = $_POST['Search'];
						$query = mysqli_query($koneksi, "SELECT * FROM produk WHERE UPPER(nama_produk) LIKE '%$kata%'");
					...
					<?php } 
						...
						echo "<tr><td>Tidak ditemukan produk dengan kata <b>$kata</b></td></tr>";
					}
